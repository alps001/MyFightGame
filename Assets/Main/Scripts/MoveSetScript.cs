...
namespace MyFightGame
{
    ...
    public class BasicMoves
    {
        ...
        public BasicMoveInfo run = new BasicMoveInfo();
    ...
    public class MoveSetScript : MonoBehaviour
    {
        ...
        void Awake()
        {
            controlsScript = transform.parent.GetComponent<ControlsScript>();
        ...
        public void changeMoveStances(CombatStances newStance)
        {
            ...
            foreach (MoveSetData moveSetData in controlsScript.myInfo.moves)
            {
                if (moveSetData.combatStance == newStance)
                {
                    ...
                    if (!opponent.Equals(gameObject) && opponent.name == gameObject.name)
                    { // Mirror Match Move cloning
        ...
        private void fillMoves()
        {
            ...
            setBasicMoveAnimation(basicMoves.run, "run", WrapMode.Loop);
