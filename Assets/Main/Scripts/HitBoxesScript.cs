...
public class HitBoxesScript : MonoBehaviour
{
    ...
    public Vector3 testCollision(BlockArea blockableArea)
    {
        ...
        foreach (HitBox hitBox in hitBoxes)
        {
            ...
            blockablePosition += new Vector3(blockableArea.offSet.x , blockableArea.offSet.y, 0);
            blockablePosition.x += (blockableArea.radius / 2) ;
    ...
    void OnDrawGizmos()
    {
        ...
        if (activeHurtBoxes != null)
        {
            ...
            foreach (HurtBox hurtBox in activeHurtBoxes)
            {
                ...
                {
                    hurtBoxPosition = hurtBox.position.position + new Vector3(hurtBox.offSet.x , hurtBox.offSet.y, 0);
                }
