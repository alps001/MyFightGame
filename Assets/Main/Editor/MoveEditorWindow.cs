                            ...
                            if (buttonSequenceToggle)
                            {
                                EditorGUILayout.BeginVertical(subGroupStyle);
                                {
                                    ...
                                    if (StyledButton("New Button Sequence"))
                                        moveInfo.buttonSequence = AddElement<ButtonPress>(moveInfo.buttonSequence, ButtonPress.Right);
                            ...
                            if (buttonExecutionToggle)
                            {
                                EditorGUILayout.BeginVertical(subGroupStyle);
                                {
                                    ...
                                    if (StyledButton("New Button Execution"))
                                        moveInfo.buttonExecution = AddElement<ButtonPress>(moveInfo.buttonExecution, ButtonPress.Punch);
